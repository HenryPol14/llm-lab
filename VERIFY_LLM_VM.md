# Проверка компонентов LLM VM (06-create-llm-vm.sh)

Этот документ содержит команды для верификации всех компонентов, которые должны быть созданы скриптом `06-create-llm-vm.sh`.
